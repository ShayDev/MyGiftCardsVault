...
export function parseFamilySettings(raw: string | null): FamilySettings {
  ...
  const days = (parsed.expiringSoonDays ?? {}) as Partial<
    FamilySettings["expiringSoonDays"]
  >;
  return {
    ...parsed,
    expiringSoonDays: {
      default: typeof days.default === "number" ? days.default : DEFAULT_SETTINGS.expiringSoonDays.default,
